# Specify the necessary imports for the agent, as well as loading environment variables from the .env file.
...
# Following code to read the prompt file that you just created
...
# following code to define the Azure AI project information and create the AI Project client
